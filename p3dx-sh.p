...
LaserAutoConnect true    ; Laser_1 exists and should be automatically connected
                         ; at startup.
LaserX 135                ; Location (in mm) of the laser in X (+ front, - back)
...
LaserPortType tcp     	 ; Type of port the laser is on. serial
LaserPort     157.253.173.241:8102            ; Port the laser is on. /dev/ttyUSB1
...
LaserIncrement          360/1024; Increment (in deg) for the laser. Fractional degrees 	240/725 240/683   0.36  
                         ; are permitted. Leave blank to use the default.
LaserIncrementChoice    360/1024 ; Increment choice for the laser. This may be used to	240/725 	240/683  0.36
